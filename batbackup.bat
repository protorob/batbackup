...
::      rclone config  ->  add:
::        type "ftp"    for the FTP remote
::        type "webdav" for Nextcloud (url = https://yourhost/remote.php/dav/files/USERNAME)
...
:: -- Remote names exactly as typed in: rclone config
...
call :UPLOAD "!ZIPPATH!" "%FTP_REMOTE%:%FTP_DEST%"  "FTP"
call :UPLOAD "!ZIPPATH!" "%NC_REMOTE%:%NC_DEST%"    "Nextcloud"
